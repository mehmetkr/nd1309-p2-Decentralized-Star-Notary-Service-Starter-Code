...
contract StarNotary is ERC721 {
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(msg.sender == owner1 || msg.sender == owner2, 'The sender must be the owner of one of the tokens');
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(msg.sender == owner, 'The sender must be the owner of the star to be transferred');
